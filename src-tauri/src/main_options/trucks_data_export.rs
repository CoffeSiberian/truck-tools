use super::truck_engines::{
    DAF_2021, DAF_XF, DAF_XF_EURO6, IVECO_HIWAY, IVECO_STRALIS, MAN_TGX, MAN_TGX_EURO6,
    MERCEDES_ACTROS, MERCEDES_NEW_ACTROS, RENAULT_MAGNUM, RENAULT_PREMIUM, RENAULT_T,
    SCANIA_R_2009_ENGINES, SCANIA_R_ENGINES, SCANIA_STREAMLINE_ENGINES, SCANIA_S_ENGINES, VOLVO_FH,
    VOLVO_FH_CLASSIC,
};
use super::truck_transmissions::{
    DAF_2021_TRANSMISSION, DAF_XF_EU6_TRANSMISSION, DAF_XF_TRANSMISSION, IVECO_HIWAY_TRANSMISSION,
    IVECO_STRALIS_TRANSMISSION, MAN_TGX_EU6_TRANSMISSION, MAN_TGX_TRANSMISSION,
    MERCEDES_ACTROS_TRANSMISSION, MERCEDES_NEW_ACTROS_TRANSMISSION, RENAULT_MAGNUM_TRANSMISSION,
    RENAULT_PREMIUM_TRANSMISSION, RENAULT_T_TRANSMISSION, SCANIA_R_2009_TRANSMISSION,
    SCANIA_R_TRANSMISSION, SCANIA_STREAMLINE_TRANSMISSION, SCANIA_S_TRANSMISSION,
    VOLVO_FH_CLASSIC_TRANSMISSION, VOLVO_FH_TRANSMISSION,
};
use crate::structs::vec_trucks::{
    BrandDaf, BrandIveco, BrandMan, BrandMercedes, BrandRenault, BrandScania, BrandVolvo,
    TruckBrands, TruckValues,
};
